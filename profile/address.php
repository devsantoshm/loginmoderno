    			...
    			<div class="right-area">
                    ...
                    <form>
                        <div class="form-group">
                            <input id="autocomplete" placeholder="Enter your address" onFocus="geolocate()" type="text" class="form-control profile-input" value="<?php if(isset($address_db)): echo $address_db; endif;?>"></input>
...
<script>
    ...
    <script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyDbI9otMIeZuNWjIMgfjH6mdwBqgxg0_Os&libraries=places&callback=initAutocomplete"
        async defer></script>
